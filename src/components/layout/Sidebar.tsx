...
const navItems = [
  ...
  { path: '/builder', label: 'Factory Builder', icon: BuilderIcon },
      ...
      <div className="border-t border-gray-200 p-4">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            ...
            <span className="font-medium">{model.stations.length}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-600">Buffers</span>
            <span className="font-medium">{model.buffers.length}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-600">Products</span>
            <span className="font-medium">{model.products.length}</span>
          </div>
          <div className="flex justify-between">
